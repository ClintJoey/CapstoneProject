...
public class UserBeneficialPlantInfoAcivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_beneficial_plant_info_acivity);
    ...
    private void fetchPlantInfo() {
        beneficialPlantsRef.child(fetchedPlantName).addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(UserBeneficialPlantInfoAcivity.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void setUIValues(BeneficialPlantModel beneficialPlant) {
        ...
        viewBeneficialPlantNutrientsRec.setLayoutManager(new LinearLayoutManager(UserBeneficialPlantInfoAcivity.this));
        PlantInfoNutrientAdapter adapter = new PlantInfoNutrientAdapter(UserBeneficialPlantInfoAcivity.this, plantNutrientsArray, plantModel.getPlantNutrientsAmount());
        ...
        for (String key: plantModel.getPlantNutrients()) {
            nutrientsRef.child(key).get().addOnSuccessListener(new OnSuccessListener<DataSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(UserBeneficialPlantInfoAcivity.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
